...
function Logout() {
    ...
    console.log(`The local storage before the clearing is: ${JSON.stringify(localStorage)}`);
  
    localStorage.clear()
    console.log(`The local storage after the clearing is: ${JSON.stringify(localStorage)}`);
  ...
  console.log("Inside the app.jsx file")
